...
VALUES('CorrectFirstName', 'CorrectLastName', X'12345678123412341234123456789101', '2001-01-01'),
('First', 'Last', X'87654321432143214321098765432109', '2005-02-02');


MERGE INTO agreements(uuid, date_from, date_to, country, premium, cost)
key (uuid)
VALUES(X'00000000000000000000000000000000', '2050-02-02', '2050-02-03', 'SPAIN', 1, 10),
